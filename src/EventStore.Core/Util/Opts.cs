...
namespace EventStore.Core.Util
{
    public static class Opts
    {
        ...
        public const string IndexMergingLevelDescr = "Throttling level for index merges.  Only disable if you plan on enabling it via the admin http request during quiet periods.";
        public static IndexMergingLevel IndexMergingLevelDefault = IndexMergingLevel.NoThrottling;
